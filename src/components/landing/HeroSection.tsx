    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-emerald-50 via-white to-white">
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex flex-col items-center pt-16 pb-20 text-center lg:pt-24 lg:pb-28">
          ...
          <h1 className="max-w-4xl text-4xl font-bold tracking-tight select-text sm:text-5xl md:text-6xl lg:text-7xl">
          ...
          <div className="mt-8 flex w-full max-w-2xl flex-col gap-4 sm:flex-row">
            <button
              type="button"
              onClick={() => {
                window.location.href = "/dashboard/user/requests/new"
              }}
              className="inline-flex h-14 flex-1 cursor-pointer items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-600 px-8 text-base font-medium text-white shadow-lg transition-all select-auto hover:from-emerald-600 hover:to-teal-700"
            >
            ...
            <button
              ...
              className="inline-flex h-14 cursor-pointer items-center justify-center gap-2 rounded-2xl border-2 border-emerald-200 px-8 text-base font-medium text-emerald-700 select-auto hover:bg-emerald-50 sm:flex-1"
            >
              Browse Services
          ...
          >
            {[
              ...
              <Link
                ...
                className="flex flex-col items-center gap-2 rounded-2xl border bg-white/80 p-4 backdrop-blur-sm transition-all hover:-translate-y-0.5 hover:border-emerald-200 hover:bg-emerald-50/50 hover:shadow-md"
              >
          ...
          >
            ...
            <div className="text-center">
              ...
              <div className="text-muted-foreground text-sm">Active Taskers</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-emerald-600">
